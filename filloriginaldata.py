...
def createArrayLabourQuotas(keyList, silentMode = "silent"):
    """ Пока одномерный массив квот рабочих часов разработчиков - пока заполняем рандомайзером.
    Впоследствии будет три строки: часы основного состава, часы резерва, допустимое превышение (%).
    Превышение может расходоваться на задачи только очень высокого и высокого приоритетов."""
    import random
    labourHourQuotas = []
